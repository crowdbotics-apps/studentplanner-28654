...
## Project Structure
    ...
    ├── studentplanner_28654  # Django project configurations
...
1. Clone this repo and `cd studentplanner_28654`
...
2. Clone this repo and `cd studentplanner_28654`
